...
export function StepCard({ stepNumber, title, codeContent, className = "" }: StepCardProps) {
  return (
    ...
    >
      {/* Watermark in bottom right - cream-soft 8% opacity */}
      <span className="absolute bottom-[-15px] right-[-5px] font-mono text-[84px] font-bold text-[var(--cream-soft)] opacity-8 select-none pointer-events-none leading-none z-0">
        {stepNumber}
      </span>
