...
export function WatermarkText({ opacity, x, letterSpacing }: { opacity: MotionValue<number>; x: MotionValue<number>; letterSpacing: MotionValue<string> }) {
  return (
    <>
      ...
      <motion.div
        aria-hidden="true"
        style={{ opacity: 0.111, x, letterSpacing }}
        className="pointer-events-none absolute right-[12vw] top-[6%] z-[1] hidden select-none whitespace-nowrap text-right text-[clamp(190px,15vw,280px)] font-black leading-none text-coral lg:block xl:right-[13vw] xl:top-[6%] xl:text-[clamp(220px,14vw,320px)] 2xl:right-[14vw] 2xl:top-[6.5%] 2xl:text-[clamp(240px,13vw,340px)]"
      >
        API
      </motion.div>
    </>
