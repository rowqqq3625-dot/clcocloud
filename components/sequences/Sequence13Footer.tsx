      ...
      <div className="container-cinematic grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="lg:text-right lg:items-end flex flex-col">
          ...
          <ul className="mt-4 grid gap-3 text-sm text-cream/54 lg:text-right">
            ...
            <li className="text-[11px] text-cream/40 mt-3 max-w-none leading-relaxed font-normal flex flex-col text-left lg:text-right lg:items-end" style={{ whiteSpace: "nowrap" }}>
              <div className="flex flex-col text-left gap-y-0.5">
                <span className="text-coral font-bold text-xs mb-0.5">클코클라우드 NOTIFY</span>
